...
var (
	_ Tickerer       = (*ticker)(nil)
	_ json.Marshaler = (*ticker)(nil)
	_ object.GetMap  = (*ticker)(nil)
)
...
func TickererComparer(
	...
	return DAOerComparer(first, second) &&
...
func (ticker *ticker) GetCreatedAt() time.Time {
	return ticker.createdAt
}

// GetUpdatedAt is a function.
func (ticker *ticker) GetUpdatedAt() time.Time {
	return ticker.updatedAt
}

// GetDeletedAt is a function.
func (ticker *ticker) GetDeletedAt() sql.NullTime {
	return ticker.deletedAt
}
...
func (ticker *ticker) GetMap() map[string]any {
	return map[string]any{
		...
		"deleted_at":        ticker.GetDeletedAt(),
		"id":                ticker.GetID(),
